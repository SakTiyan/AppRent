...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-brand-light px-4">
        ...
        <div class="bg-white p-8 md:p-10 rounded-2xl shadow-xl w-full max-w-md border-t-4 border-brand-blue"
            data-aos="zoom-in" data-aos-duration="1000">

            <div class="text-center mb-8">
                <img src="{{ asset('assets/img/logo-square.png') }}" alt="Logo AppRent"
                    class="w-20 mx-auto mb-4 drop-shadow-md">
                <h2 class="text-2xl font-bold text-brand-dark tracking-tight">Login <span
                        class="text-brand-amber">AppRent</span></h2>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-500">Belum punya akun?
                    <a href="{{ route('register') }}"
                        class="font-bold text-brand-blue hover:text-brand-amber transition">Daftar sekarang</a>
                </p>
            </div>
