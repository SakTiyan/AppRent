...
<div class="max-w-2xl mx-auto space-y-6" data-aos="fade-up">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Edit Data Kasir</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Ubah informasi akun staf kasir atau perbarui kata sandinya.</p>
        </div>
    </div>
